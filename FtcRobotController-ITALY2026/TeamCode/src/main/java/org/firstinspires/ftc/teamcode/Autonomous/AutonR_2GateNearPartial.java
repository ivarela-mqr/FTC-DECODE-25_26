...
@Autonomous(name = "RED_2GateNearPartial", group = "Autonomous")
@Configurable
public class AutonR_2GateNearPartial extends OpMode {
    ...
    public void init() {
        ...
        shootingStateMachine.init(hardwareMap,
                org.firstinspires.ftc.teamcode.util.Constants.Alliance.RED,1200, IntakeStateMachineStates.FINAL,
                new Pose(91,90));
